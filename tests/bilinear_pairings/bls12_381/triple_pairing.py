...
def test_triple_pairing():
    ...
    output = bls12_381_curve.triple_pairing(P1,P2,P3,Q1,Q2,Q3)
    
    unlock = bls12_381.triple_pairing_input(
        P1=P1.to_list(),
        P2=P2.to_list(),
        P3=P3.to_list(),
        Q1=Q1.to_list(),
        ...
        miller_output_inverse=bls12_381_curve.triple_miller_loop_on_twisted_curve(P1,P2,P3,Q1,Q2,Q3,'quadratic').invert().to_list()
    )
    
    # Check correct evaluation
    lock = bls12_381.triple_pairing(modulo_threshold=1,check_constant=True,clean_constant=True)
...
print('\nTriple pairing BLS12_381: all tests successful ------\n')