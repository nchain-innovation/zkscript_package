...
def test_triple_miller_loop():
    ...
    output = mnt4_753_curve.triple_miller_loop_on_twisted_curve(P1,P2,P3,Q1,Q2,Q3,denominator_elimination='quadratic')
    
    unlock = mnt4_753.triple_miller_loop_input(
        P1=P1.to_list(),
        P2=P2.to_list(),
        P3=P3.to_list(),
        Q1=Q1.to_list(),
    ...
    lock = mnt4_753.triple_miller_loop(modulo_threshold=1,check_constant=True,clean_constant=True)
...
print('\nTriple Miller loop MNT4_753: all tests successful --------\n')