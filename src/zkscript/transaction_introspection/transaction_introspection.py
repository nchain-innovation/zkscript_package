...
class TransactionIntrospection:
    ...
    def pushtx(
        ...
        Stack input:
            - stack:    [GROUP_ORDER_INT, Gx, 0220||Gx_bytes||02, .., sig_hash_preimage, ..]
            - altstack: []
        Stack output:
        ...
        # stack in:  [GROUP_ORDER_INT, Gx, 0220||Gx_bytes||02, .., sig_hash_preimage, ..]
        # stack out: [GROUP_ORDER_INT, Gx, 0220||Gx_bytes||02, .., sig_hash_preimage, ..,
