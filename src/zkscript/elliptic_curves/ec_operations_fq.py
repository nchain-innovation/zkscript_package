...
class EllipticCurveFq:
    ...
    def point_addition(
        ...
        batched_modulo = mod(stack_preparation="")  # Mod out y
        batched_modulo += Script.parse_string("OP_TOALTSTACK")
        batched_modulo += mod(stack_preparation="")  # Mod out x
        ...
        check_lambda += mod(stack_preparation="", is_mod_on_top=False, is_constant_reused=False)  # take the mod
