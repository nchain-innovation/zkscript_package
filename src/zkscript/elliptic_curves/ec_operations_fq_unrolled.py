...
class EllipticCurveFqUnrolled:
    ...
    def unrolled_multiplication_input(
        ...
        Args:
            point_p (list[int]): The elliptic curve point multiplied.
            a (int): The scalar `a` used to multiply `point_p`.
        ...
        Example:
            ...
            >>> a = 3
            >>> lambdas = [[[8], [10]]]
            >>> ec_curve_unrolled.unrolled_multiplication_input(point_p, a, lambdas, max_multiplier=8)
            0x11 OP_0 OP_10 OP_1 OP_8 OP_1 OP_0 OP_0 OP_0 OP_0 OP_6 OP_11

             ^     ^          ^         ^         ^         ^     ^    ^
             q   marker     adding   doubling    pass      pass   point_p
        """
