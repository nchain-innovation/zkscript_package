...
def fq4_for_towering(mul_by_non_residue):
	"""
	Function to export Fq4 class below together with a mul_by_non_residue method which is used to construct towering extensions
	"""
...
class Fq4:
	'''
	F_q^4 built as quadratic extension of F_q^2. The non residue is specified by defining the method self.BASE_FIELD.mul_by_non_residue.
	'''

	def __init__(self, q:int, base_field, gammas_frobenius: Optional[list[list[int]]] = None):
		# Characteristic of the field
		self.MODULUS = q
		# Script implementation of the base field Fq2
		self.BASE_FIELD = base_field
		# Gammas for the Frobenius - list of [gamma1,gamma2,...,gamma3] where gammai = [gammai1], with gammai1 = NON_RESIDUE_OVER_FQ2.power((q**i-1)//2)
	...
	def add(self, take_modulo: bool, check_constant: Optional[bool] = None, clean_constant: Optional[bool] = None, is_constant_reused: Optional[bool] = None) -> Script:
		...
		if take_modulo:
			...
			out += fq2.add(take_modulo=True,check_constant=False,clean_constant=clean_constant,is_constant_reused=True)			# Compute (x_0 + y_0)
	...
	def square(self, take_modulo: bool, check_constant: Optional[bool] = None, clean_constant: Optional[bool] = None, is_constant_reused: Optional[bool] = None) -> Script:
		...
		if take_modulo:
			...
			out += fq2.mul(take_modulo=False,check_constant=False,clean_constant=False)
			out += Script.parse_string('OP_2')
			out += fq2.scalar_mul(take_modulo=False,check_constant=False,clean_constant=False)						# Top of the stack is now 2 * x_0 * x_1 (not mod by q)
	...
	def add_three(self,take_modulo: bool, check_constant: Optional[bool] = None, clean_constant: Optional[bool] = None, is_constant_reused: Optional[bool] = None) -> Script:
		...
		if take_modulo:
			# After this, the stack is: x0 + y0 + z0, altstack = [x1 + y1 + z1]
			out += fq2.add_three(take_modulo=True,check_constant=False,clean_constant=clean_constant,is_constant_reused=True)
			# Batched modulo operations: pull from altstack, rotate, mod out, repeat
			out += Script.parse_string('OP_FROMALTSTACK OP_ROT')
			out += Script.parse_string('OP_TUCK OP_MOD OP_OVER OP_ADD OP_OVER OP_MOD')
			out += Script.parse_string('OP_FROMALTSTACK OP_ROT')
	...
	def frobenius_odd(self, n: int, take_modulo: bool, check_constant: Optional[bool] = None, clean_constant: Optional[bool] = None, is_constant_reused: Optional[bool] = None) -> Script:
		...
		if is_constant_reused:
			...
			out += fq2.conjugate(take_modulo=take_modulo,check_constant=False,clean_constant=clean_constant,is_constant_reused=True)
			...
			out += fq2.conjugate(take_modulo=take_modulo,check_constant=False,clean_constant=clean_constant,is_constant_reused=False)
	...
	def frobenius_even(self, n: int, take_modulo: bool, check_constant: Optional[bool] = None, clean_constant: Optional[bool] = None, is_constant_reused: Optional[bool] = None) -> Script:
		...
		if take_modulo:
			...
			if is_constant_reused:
				# After this, the stack is: [q, a0 % q], altstack = [b*gamma, a1 % q]
				batched_modulo += Script.parse_string('OP_TUCK OP_MOD OP_OVER OP_ADD OP_OVER OP_MOD')
	...
	def conjugate(self, take_modulo: bool, check_constant: Optional[bool] = None, clean_constant: Optional[bool] = None, is_constant_reused: Optional[bool] = None) -> Script:
		...
		if take_modulo:
			...
			batched_modulo += Script.parse_string('OP_FROMALTSTACK OP_ROT')
			if is_constant_reused:
				# After this, the stack is: (x0 % q) (-x1 % q)_0 q (-x1 % q)_1
				batched_modulo += Script.parse_string('OP_TUCK OP_MOD OP_OVER OP_ADD OP_OVER OP_MOD')
			else:
