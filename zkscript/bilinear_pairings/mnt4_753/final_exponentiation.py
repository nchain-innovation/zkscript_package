...
from zkscript.bilinear_pairings.mnt4_753.fields import fq2_script, fq4_script
from zkscript.bilinear_pairings.mnt4_753.parameters import exp_miller_loop
...
class FinalExponentiation(CyclotomicExponentiation):
	...
	def easy_exponentiation_with_inverse_check(self, take_modulo: bool, check_constant: Optional[bool] = None, clean_constant: Optional[bool] = None, is_constant_reused: Optional[bool] = None) -> Script:
		...
		check_f_inverse += fq4.mul(take_modulo=True,check_constant=False,clean_constant=False,is_constant_reused=False)			# Multiply
		...
		easy_exponentiation = fq4.frobenius_even(n=2,take_modulo=False,check_constant=False,clean_constant=False)										# Compute f^(q^2)
		easy_exponentiation += fq4.mul(take_modulo=take_modulo,check_constant=False,clean_constant=clean_constant,is_constant_reused=is_constant_reused)	# Compute f^(q^2) * Inverse(f)
	...
	def hard_exponentiation(self, take_modulo: bool, modulo_threshold: int, check_constant: Optional[bool] = None, clean_constant: Optional[bool] = None) -> Script:
		...
		out += pick(position=3,nElements=4)
		out += self.cyclotomic_exponentiation(exp_e=exp_miller_loop,take_modulo=True,modulo_threshold=modulo_threshold,check_constant=False,clean_constant=False)
		...
		out += fq4.mul(take_modulo=take_modulo,check_constant=False,clean_constant=clean_constant,is_constant_reused=False)
