...
from zkscript.bilinear_pairings.mnt4_753.fields import fq4_script

class MillerOutputOperations(Fq4ScriptModel):
	'''
	Implementation of arithmetic for Miller loop of MNT4_753

	Output of line evaluations are sparse elements in Fq4, i.e., they are of the form: a + bu + cus, where F_q^4 = F_q^2[s] / (s^2 - u) = F_q[u,s] / (s^2 -  u, u^2 - 13)
	'''
	...
	def line_eval_times_eval(self, take_modulo: bool, check_constant: Optional[bool] = None, clean_constant: Optional[bool] = None, is_constant_reused: Optional[bool] = None) -> Script:
		...
		# After this, the stack is: # After this, the stack is: a1 b1 c1 a2 b2 c2, altstack = [fourthComponent, 12*(b1*c2 + c1*b2)]
		...
		# After this, the stack is: # After this, the stack is: a1 b1 a2 b2, altstack = [fourthComponent, thirdComponent, a1*b2 = b1*a2 + c1*c2*13]
		...
		# After this, the stack is: # After this, the stack is: a1*a2 + b1*b2*13, altstack = [fourthComponent, thirdComponent, secondComponent]
	...
	def miller_loop_output_times_eval(self, take_modulo: bool, check_constant: Optional[bool] = None, clean_constant: Optional[bool] = None, is_constant_reused: Optional[bool] = None) -> Script:
		...
		compute_second_component += fq2.scalar_mul(take_modulo=False,check_constant=False,clean_constant=False,is_constant_reused=False)
		compute_second_component += fq2.mul_by_non_residue(take_modulo=False,check_constant=False,clean_constant=False,is_constant_reused=False)
		...
		compute_second_component += fq2.mul(take_modulo=False,check_constant=False,clean_constant=False,is_constant_reused=False)
		compute_second_component += fq2.add(take_modulo=False,check_constant=False,clean_constant=False,is_constant_reused=False)
		...
		compute_first_component += fq2.scalar_mul(take_modulo=False,check_constant=False,clean_constant=False,is_constant_reused=False)
		compute_first_component += Script.parse_string('OP_2ROT OP_2ROT')
		compute_first_component += fq2.mul(take_modulo=False,check_constant=False,clean_constant=False,is_constant_reused=False)
		if take_modulo:
			...
			compute_first_component += fq2.add(take_modulo=False,check_constant=False,clean_constant=False,is_constant_reused=False)
